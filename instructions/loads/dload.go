...
func (d *DLOAD) Execute(frame *jvmstack.Frame) {
	_dload(frame, d.Index)
}

func _dload(frame *jvmstack.Frame, index uint) {
...
func (d *DLOAD_0) Execute(frame *jvmstack.Frame) {
	_dload(frame, 0)
}
...
func (d *DLOAD_1) Execute(frame *jvmstack.Frame) {
	_dload(frame, 1)
}
...
func (d *DLOAD_2) Execute(frame *jvmstack.Frame) {
	_dload(frame, 2)
}
...
func (d *DLOAD_3) Execute(frame *jvmstack.Frame) {
	_dload(frame, 3)
}
