...
func init() {
	...
	native.Register(unixfs, "initIDs", "()V", ufsInitIDs)

}

func ufsInitIDs(frame *jvmstack.Frame) {
	// todo
}

// private native String canonicalize0(String path) throws IOException;
// (Ljava/lang/String;)Ljava/lang/String;
func canonicalize0(frame *jvmstack.Frame) {
...
// (Ljava/io/File;)I
func getBooleanAttributes0(frame *jvmstack.Frame) {
	vars := frame.LocalVars()
	f := vars.GetRef(1)
	path := _getPath(f)
