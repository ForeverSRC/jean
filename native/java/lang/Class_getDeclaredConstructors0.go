...
func getDeclaredConstructors0(frame *jvmstack.Frame) {
	...
	if constructorCount > 0 {
		...
		for i, constructor := range constructors {
			...
			ops := jvmstack.NewOperandStack(9)
...
func init() {
	native.Register(constants.JavaLangClass, "getDeclaredConstructors0", "(Z)[Ljava/lang/reflect/Constructor;", getDeclaredConstructors0)
}
