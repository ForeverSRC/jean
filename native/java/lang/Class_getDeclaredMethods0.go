...
func getDeclaredMethods0(frame *jvmstack.Frame) {
	...
	if methodCount > 0 {
		...
		for i, method := range methods {
			...
			ops := jvmstack.NewOperandStack(12)
...
func init() {
	native.Register(constants.JavaLangClass, "getDeclaredMethods0", "(Z)[Ljava/lang/reflect/Method;", getDeclaredMethods0)
}
